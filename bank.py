...
class Bank(object):
	...
	def __init__(self, fileName = None):
		'''Creates a new dictionary to hold the accounts. if the filename is provided loads the accounts from a file of pickeled accounts'''
		self._accounts = {}
	...
	def add(self, account):
		'''Inserts an ccount using its PIN as a key'''
	...
	def save(self, fileName = None):
		'''Saves pickeled accounts to a file. The parameter allows the user to change filename'''
		if fileName != None:
			self._fileName = fileName
