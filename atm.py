'''Chapter 8 ATM Project 

atm.py
This module defines a GUI based ATM class and its applications 
'''
...
class ATM(Frame):
	'''This class represents GUi based ATM transaction'''
